...
author: Alexandre
post_date: 2018-03-21 01:49:58
layout: page
link: >
  http://sobieski.name/informatique/page-d-exemple/
published: true
tags: [ ]
categories: [ ]
---
...
Étant donné que vous êtes un nouvel utilisateur ou une nouvelle utilisatrice de WordPress, vous devriez vous rendre sur votre <a href="http://sobieski.name/informatique/wp-admin/">tableau de bord</a> pour effacer la présente page, et créer de nouvelles pages avec votre propre contenu. Amusez-vous bien !